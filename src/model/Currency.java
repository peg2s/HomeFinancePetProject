...
public class Currency extends Common {
    ...
    public Currency(String title, String code, double rate, boolean isOn, boolean isBase) throws ModelException {
        ...
        else if (code.length() == 0) throw new ModelException(ModelException.CODE_EMPTY);
        else if (rate <= 0 ) throw new ModelException(ModelException.RATE_INCORRECT);
        this.title = title;
        this.code = code;
        this.rate = rate;
        this.isOn = isOn;
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(currency.getRate(), getRate()) == 0 &&
                isOn() == currency.isOn() &&
                isBase() == currency.isBase() &&
                getTitle().equals(currency.getTitle()) &&
