...
// надо чтобы в случае невозможности по какой-то причине обновить курсы валют, пользователю показывалось сообщение а-ля "Не удалось обновить курсы валют. Повторите запрос позднее"
...
public class RateCurrency {
    ...
    public static HashMap<String, Double> getRates(Currency base) throws Exception {
        ...
        HashMap<String, Double> rates = new HashMap(); // возвращаемая мапа с готовыми значениями
